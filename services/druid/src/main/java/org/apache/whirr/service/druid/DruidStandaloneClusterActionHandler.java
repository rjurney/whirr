...
public class DruidStandaloneClusterActionHandler extends ClusterActionHandlerSupport {

    private static final Logger LOG =
            LoggerFactory.getLogger(DruidStandaloneClusterActionHandler.class);
    ...
    protected Configuration getConfiguration(ClusterSpec spec)
            throws IOException {
        return getConfiguration(spec, "whirr-druid-default.properties");
    }
                ...
                new Function<Instance, String>() {
                    ...
                    public String apply(Instance instance) {
                        try {
                            ...
                            return String.format("%s:%d", host, REALTIME_PORT);
                        } catch (IOException e) {
